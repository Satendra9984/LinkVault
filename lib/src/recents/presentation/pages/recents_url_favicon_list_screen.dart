...
import 'package:link_vault/src/common/presentation_layer/pages/add_url_template_screen.dart';
import 'package:link_vault/src/common/presentation_layer/pages/update_collection_template_screen.dart';
import 'package:link_vault/src/common/presentation_layer/pages/url_favicon_list_template_screen.dart';
...
import 'package:link_vault/src/common/presentation_layer/widgets/url_favicon_widget.dart';
import 'package:link_vault/src/common/repository_layer/enums/url_launch_type.dart';
...
class RecentsUrlFaviconListScreen extends StatefulWidget {
  const RecentsUrlFaviconListScreen({
  ...
  @override
  State<RecentsUrlFaviconListScreen> createState() =>
      _RecentsUrlFaviconListScreenState();
}

class _RecentsUrlFaviconListScreenState
    extends State<RecentsUrlFaviconListScreen>
